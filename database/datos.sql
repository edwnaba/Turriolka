...
INSERT INTO `tu_empresa`
(`atId`,
`atHistoria`,
`atQuienesSomos`,
`atMision`,
`atVision`,
`atDescripcionProductos`,
`atDescripcionGaleria`,
`atDescripcionPremios`,
`atDireccion`,
`atCorreo`,
`atTelefono`,
`atIdioma`)
...
`atcodigoImagen`)
VALUES
(0,'ac','gfg',0,0),(0,'ac','gfg',1,0);

-- inicio*********************************************************88
INSERT INTO `tu_imagen`
(`atId`,
`atNombre`)
VALUES
(0,
'crg67cccccccccccccccc');
